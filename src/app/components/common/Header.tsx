  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-white shadow-md z-40 flex items-center px-4 lg:px-6">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h1 className="text-lg font-semibold text-gray-800">Warehouse Inventory Management System</h1>
          <p className="text-xs text-gray-500">Balai Monitor Spektrum Frekuensi Radio Kelas 1 Semarang</p>
        </div>
      </div>
